  ...
  return (
    <div className="flex flex-wrap justify-center gap-2 pt-1">
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={pluxee} alt="Bandeira Pluxee" />
      </div>
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={ticket} alt="Bandeira Ticket" />
      </div>
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={vr} alt="Bandeira Vr" />
      </div>
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={alelo} alt="Bandeira Alelo" />
      </div>
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={ben} alt="Bandeira Ben" />
      </div>
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={biq} alt="Bandeira Biq" />
      </div>
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={cooper} alt="Bandeira Cooper" />
      </div>
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={green} alt="Bandeira Greencard" />
      </div>
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={sorocred} alt="Bandeira SoroCred" />
      </div>
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={vale} alt="Bandeira ValeCard" />
      </div>
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={verdcard} alt="Bandeira VerdCard" />
      </div>
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={abrapetite} alt="Bandeira Abrapetite" />
      </div>
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={viasoft} alt="Bandeira Viasoft" />
      </div>
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={uauh} alt="Bandeira Uauh beneficios" />
      </div>
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={vegas} alt="Bandeira Vegas" />
      </div>
      <div className="h-[30px] w-[45px] lg:h-[38px] lg:w-[56px]">
        <img src={volus} alt="Bandeira Volus" />
      </div>
    </div>
  );
}
